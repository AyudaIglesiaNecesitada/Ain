...
<main class="container" id="content_main">
	<!--SECCION DONATIVOS-->
	<div id="content_info">
		<p class="title_info_donacion">Con tu donación de <span id="monto_donacion"></span></p>
		<p class="title_info_donacion">Apoyaras: <span id="nombre_campaña"></span></p>
		<h5 class="title_gracias" id="title_no_existe">Hola <span class="nombre_donante"></span>, <span id="client_exist">gracias por volver a donar,</span> sí deseas modificar tus datos activa la edición aquí.</h5>
		<h5 class="title_gracias hide" id="title_no_existe">Por favor completa los siguientes datos para recibir el certificado de desgravación fiscal.</h5>

	  <!--RADIO BUTTONS INDIVIDUAL / ORGANIZACION-->
	<div class="row">
        <div class="input-field tipos_pago col s12 quitar-padding">
          <div class="col s6 individual quitar-padding">
		    <p>
		      <label>
	...
	<form class="col s12" id="form_desgravacion_individual">	  
		<div class="row">   
	        <div class="input-field col s12">
	          <div class="col datos">
		          	  <!-- Switch -->
				  <div class="switch switch_content">
				    <label>
	        ...
	        <div class="input-field col s12 data_hide">
	          ...
	          <div class="col dato_via tipo_via_individual">
			    <select id="tipo_via">
	        ...
	        <div class="input-field col s12 data_hide">
	          ...
	          <div class="col datos_ubicacion provincia">
			    <select id="provincia">
			    </select>
	          ...
	          <div class="col datos_ubicacion ciudad">
			    <select id="ciudad">
			    </select>
	        ...
	        <div class="input-field col s12 data_hide">
	          ...
	          <div class="col datos">
	          	<input type="text" id="birth_date" class="datepicker" placeholder="Fecha de nacimiento">
	          </div>
	...
	<form class="col s12" id="form_desgravacion_organizacion">
		<div class="row">
	        ...
	        <div class="input-field col s12 data_hide_organizacion">
	          ...
	          <div class="col dato_via tipo_via_empresa">
	        ...
	        <div class="input-field col s12 data_hide_organizacion">
	          ...
	          <div class="col datos_ubicacion provincia_empresa">
	          ...
	          <div class="col datos_ubicacion ciudad_empresa">
