        ...
        <!--nav logo-->
          ...
          <div id="imagen_content">
            <div id="titulo_container">
                  <div class="row">
                    <div class="imagen_campaña" style="background-image: url(<?php echo $img_campana?>);">
                    </div>
                    <div class="titulo_campaña">
                      <span class="img_fondo" style="background-image: url(<?php echo $img_campana ?>);"></span>
            ...
            <div id="titulo_container">
                  <div class="row">
                    ...
                    <div class="titulo_campaña">
                      ...
                      <h4><?php echo $titulo_campana_gnral ?></h4>
                    </div>
                  </div>                 
            </div>
          </div>
