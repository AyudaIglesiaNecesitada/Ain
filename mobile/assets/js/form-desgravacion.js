...
$('.datepicker').datepicker({ 
            ...
            format: 'dd-mm-yyyy',
            i18n: {
                months: ["Enero", "Febrero", "Marzoooo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"],
...
$("#btn_enviar").click(function (e) {
    ...
    if (operation == 1) {
       ...
       var birth_date;
       if($('#birth_date').val() != '') {
           var fa = $('#birth_date').val().split('-');
           birth_date = fa[2]+"-"+fa[1]+"-"+fa[0]
       } else {
            birth_date = '';
       }
       ...
       var renovalDate2 = renew_date2[2]+"-"+renew_date2[1]+"-"+renew_date2[0];
        ...
        if (pais == "España") {
            //console.log("España")
              if (nif != "" && nombre != "" && apellido != "" && /^(([^<>()[\]\.,;:\s@\"]+(\.[^<>()[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i.test(email) && telefono != "" && tipovia != "" && nombre_via != "" && numero != "" && piso != "" && letra != "" && rest != "" && cp != "" && provincia != "" && ciudad != "") {
                ...
                if ($( "#aceptar_politicas_individual" ).prop("checked")) {
          ...
          console.log("No españa")
            ...
            if (nif != "" && nombre != "" && apellido != "" && /^(([^<>()[\]\.,;:\s@\"]+(\.[^<>()[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i.test(email) && telefono != "" && pais != "") {
                $('#btn_enviar').attr('disabled', 'disabled');
                $('#btn_enviar').append('<i class="material-icons" id="loading-i">autorenew</i>');
                $('#loading-i').addClass('spin-loader')
                var objectDataTax = {
