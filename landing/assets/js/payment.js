                    ...
                    switch ($('#check_desgravacion').prop('checked')) {
                        case true:
                            if($('#check_donacion_anonima').prop('checked')) {
                                window.setTimeout(() => {
                                    window.location.href = '/donar/gracias.php?cid='+objectData.campana
                                }, 4000);
                            } else {
                                if(response.client.new_client) {
                                    ...
                                    window.setTimeout(() => {
                                        window.location.href = '/donar/form-gracias.php?cid='+objectData.campana
                                    }, 4000);
                                }
                            }
                            break;
                        case false:
                            if(response.client.new_client) {
                                window.setTimeout(() => {
                                    window.location.href = '/donar/desgravacion.php?cid='+objectData.campana
                                }, 4000);
                            } else {
                                window.setTimeout(() => {
                                    window.location.href = '/donar/desgravacion.php?cid='+objectData.campana
...
function validateCommons() {
    if ($( "#tratamiento option:selected" ).val() == '') {
        $('.tratamiento input').addClass('border-danger');
        $('.vali_tratamiento').removeClass('hide');
    } else {
        $('#tratamiento option:selected').removeClass('border-danger');
        $('.tratamiento input').addClass('border-success');
        $('.vali_tratamiento').addClass('hide');
    } 
    if ($('#nombre').val() == '') {
